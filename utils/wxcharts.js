...
function drawXAxis(categories, opts, config, context) {
    ...
    var endY = opts.height + config.xAxisLineHeight;
    context.save();
    ...
    context.beginPath();
    context.setStrokeStyle(opts.xAxis.gridColor || "#eee");
    //console.log(opts.xAxis.disableGrid);
    if (opts.xAxis.disableGrid !== true) {
        if (opts.xAxis.type === 'calibration') {
            ...
            var xCounting=8;
            var xMargin = opts.width / xCounting;
            for(var i=1;i<xCounting+1;i++){
              if(((i-1)*xMargin+xAxisPoints[0]+5)<opts.width-10){
                context.moveTo((i - 1) * xMargin+xAxisPoints[0]+5, startY);
                context.lineTo((i - 1) * xMargin + xAxisPoints[0]+5, -endY);
              }
            }
            xAxisPoints.forEach(function (item, index) {
...
function drawYAxisGrid(opts, config, context) {
    ...
    context.beginPath();
    context.setStrokeStyle(opts.yAxis.gridColor || "#eee");
    context.setLineWidth(1);
...
function drawRadarDataPoints(series, opts, config, context) {
    ...
    context.beginPath();
    context.setLineWidth(1);
    context.setStrokeStyle(radarOption.gridColor || "#eee");
